...
/*
 *  input  : RecordCriteria(요청페이지,한페이지당 보여줄 레코드수),
 *  				 totalRec(총레코드수), 한페이지에 보여줄 페이지수
 *  
 *  output : 시작페이지, 종료페이지, 최종페이지, 이전버튼표시유무, 다음버튼표시유무
 */
public class PageCriteria {

	private int pageNumPerPage;  //한페이지에 보여줄 페이지수
	...
	public RecordCriteria recordCriteria;	//한페이지에 보여줄 레코드수, 요청페이지
	...
	public String toString() {
		return "PageCriteria [pageNumPerPage=" + pageNumPerPage + ", startPage=" + startPage + ", endPage="
