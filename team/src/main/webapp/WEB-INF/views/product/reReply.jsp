...
<div class="container">
  ...
  <!-- toasts -->
<div role='alert' aria-live='assertive' aria-atomic='true' class='toast' id='t-del-msg' style="position:fixed; width:200px; right:50px; bottom:50px;" data-autohide='true' data-delay='1500'>
	...
	<div class='toast-body'>댓글이 삭제됨.</div>
</div>
